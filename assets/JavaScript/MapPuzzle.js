...
var startLocationArray = [
  {
    Location: "Big Ben",
    Hint: "I have four faces, yet cannot see I have eight hands but cannot touch I sit beside the seats of power, What am I?"
  }
...
var answerArray = [
  ...
  {
    Location: "Stonehenge",
    Hint: "My creator is a mystery, One that's set in stone. My origins, my history, Still totally unknown.",
    Correct: "Amesbury, Salisbury SP4 7DE, UK"
  },
...
$("#mapAnswerSubmit").on("click", function() {
  ...
  var userInput = $("#mapAnswerInput").val().trim();
